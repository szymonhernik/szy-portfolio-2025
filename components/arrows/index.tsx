export function ArrowLeft({ width = 24, height = 24 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95.05 79.16" width={width} height={height} className="">
      <path
...
export function ArrowRight({ width = 24, height = 24 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="" viewBox="0 0 95.05 79.16" width={width} height={height}>
      <path
        className="arrow-path "
