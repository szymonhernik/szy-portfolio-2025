          ...
          <div>
            <p>
              <span className="max-md:block max-md:pr-7 max-md:text-fluid-lg">
                {" "}
                Szy embodies a sense of fluidity that courses through their
                practice and personality. Not one to bend with the tide but to
                navigate it personality. Not one to bend with the tide but to
                navigate it thoughtfully, they approach design with an instinct
                for negotiation—balancing precision with play and structure with
                flow.
              </span>{" "}
              <span className="max-md:mt-12 max-md:block">
                In collaboration, Szy brings an empathetic, curious approach to
                every project, enriched by their penchant for learning (be it a
                new coding tool or an unexpected artistic technique) and their
                observant nature. Their sketchbook, a constant companion, is
                both a sanctuary for ideas and a method of untethering oneself
                from screens – a nod to the tactile joys of creation.
              </span>
            </p>
            <p className="max-md:mt-12">
              As a designer, Szy specialises in motion design, graphic design,
              art direction, web design, editorial design and identity design.
              As a developer, Szy’s fluency extends to{" "}
              ...
              , and{" "}
              <TagLink slug="back-end-development">
                back-end development
              </TagLink>
              .
            </p>
            <p className="max-md:mt-12">
              Szy hones their multifaceted workspace to remain a site of
              perpetual inquiry. Their workspace is blessed to have welcomed
              collaborations with:{" "}
              <a
                target="_blank"
            ...
            <div className="flex-1">
              ...
              <div>
                <p>
                  ...
                  <br />
                  Co-founder and Designer (2022 — present)
                </p>
                <p>
                  Freelance Graphic Designer and Web Developer (2020 — present)
                </p>
                <p>
                  <a
                    href="https://nmr.cc"
