      ...
      <div className="col-span-12 flex flex-col gap-X md:col-span-10 lg:col-span-7 ">
        ...
        <div className="flex flex-col gap-X md:flex-row">
          <div className="flex-1">
            <h1 className="mb-6 text-fluid-xl md:mb-5 md:text-[length:inherit]">Experience</h1>
            <div>
              <p>
          ...
          <div className="flex-1">
            <h1 className="mb-6 text-fluid-xl md:mb-5 md:text-[length:inherit]">Education</h1>
            <div>
              <p>
