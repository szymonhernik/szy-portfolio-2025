...
export default function Information() {
  return (
    <section className="relative grid grid-cols-12 items-start">
      ...
      <div className="col-span-12 flex flex-col gap-12 md:gap-X md:col-span-10 lg:col-span-7 ">
        <div>
          <p>
            <span className="max-md:text-fluid-lg max-md:block max-md:pr-7">
              {" "}
            ...
            <span className="max-md:block max-md:mt-12">
              ...
              observant nature. Their sketchbook, a constant companion, is both
              a sanctuary for ideas and a method of untethering oneself from
              screens – a nod to the tactile joys of creation.
            </span>
          </p>
