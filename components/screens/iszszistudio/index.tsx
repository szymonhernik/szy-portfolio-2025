    ...
    <section className="flex min-h-[calc(100dvh-2rem)] w-full flex-col justify-between overflow-y-auto">
      <div className="grid grid-cols-12 ">
        <div className="col-span-12 md:col-span-10 lg:col-span-7">
          <p>
            <Link href="https://iszszistudio.com">isz szi</Link> is an
            ambivalently focused studio that continues to find different ways of
            expression and labour.
          </p>
          <p>
            In our work we always try to reflect on what's structurally at
            stake. We think a lot about what it means and how to collaborate,
            and how to sustain an ethics of love in times of austerity. We
            remain impressed by oeuvres such as Frost&Lynch's Twin Peaks series
            or the newest publishing venture in Poland called Współbycie.
          </p>
          <p>
            Our most recent projects include a website for Polish musician{" "}
            <Link
              target="_blank"
              href="https://zaumne.com"
            ...
            <Link
              target="_blank"
              href="https://iszszistudio.substack.com"
              className="text-link hover:font-outline-1-secondary"
            >
              branches
            </Link>{" "}
            ...
            <Link
              target="_blank"
              href="https://www.instagram.com/p/CvepmI3otWU/"
              className="text-link hover:font-outline-1-secondary"
            >
              Sanatorium of Sound
            </Link>
            . What has been inspiring us lately are songs, dogs and throwing
            balls.
          </p>
        </div>
      </div>
      <div className="w-full">
        ...
        <p className="mt-4 text-small">
          ...
          <Link
            target="_blank"
            href="https://www.instagram.com/ireee_nka/"
            className="text-link hover:font-outline-1-secondary"
          >
            ire
          </Link>{" "}
