      ...
      {mounted && (
        <div className="embla flex max-h-[800px] flex-col gap-2">
          ...
          >
            ...
            <div
              className="absolute top-0 bottom-7 left-0 flex w-1/2 cursor-w-resize items-center"
              onClick={scrollPrev}
            />
            ...
            {/* biome-ignore lint/a11y/useKeyWithClickEvents: not needed */}
            <div
              className="absolute top-0 right-0 bottom-7 flex w-1/2 cursor-e-resize items-center"
              onClick={scrollNext}
            />
          </div>
