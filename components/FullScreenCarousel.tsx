          ...
          <div className="embla h-full w-full max-w-screen md:w-3/4">
            <div className="embla__viewport h-full" ref={emblaRef}>
              ...
              {allSlides[selectedIndex]?.caption ? (
                <div className="fixed inset-x-4 bottom-16 text-center sm:text-small md:bottom-4 md:left-4 md:mb-0 md:max-w-[80%] md:text-left lg:text-small-md [&>p]:mb-0 ">
                  <PortableTextRenderer value={allSlides[selectedIndex].caption} />
                </div>
              ) : (
                allSlides[selectedIndex]?.defaultCaption && (
                  <p className="fixed inset-x-4 bottom-16 text-center sm:text-small md:bottom-4 md:left-4 md:mb-0 md:max-w-[80%] md:text-left lg:text-small-md [&>p]:mb-0 ">
                    {allSlides[selectedIndex].defaultCaption}
                  </p>
                )
              )}
